...
public class Ken_CLMSMainTest implements ITestScript{
	...
	public void runTest() {
		...
		this.login();	
		Ken_MyLearningPageAct.clickMyLearning(driver, logger);
		Ken_MyLearningPageAct.validateMyLearningNavLink(driver, logger);
		this.logUpdateScenario();
			
		this.logScenario(this.ts.getID() + "B", "User can navigate to My Teaching");
		Ken_MyTeachingPageAct.clickMyTeaching(driver, logger);
		Ken_MyTeachingPageAct.validateMyTeachingNavLink(driver, logger);
		this.logUpdateScenario();
		
		this.logScenario(this.ts.getID() + "C", "User can view the Campus");
		Ken_MyTeachingPageAct.validateSchoolName(driver, logger);
